...
3. OpenSpec reconcilia delta-spec → spec canônica nativamente (`/opsx:sync`, default desde v1.4.0, 2026-06-01), mas NÃO reconcilia spec↔código: o `sync` confia no documento delta e nunca verifica a implementação. O passo de reconciliação spec↔código continua a ser construído por nós.
...
| AI productivity evidence | [METR RCT 2025-07](https://metr.org/blog/2025-07-10-early-2025-ai-experienced-os-dev-study/) + [METR 2026 uplift update](https://metr.org/blog/2026-02-24-uplift-update/) + [AI usage survey](https://metr.org/blog/2026-05-11-ai-usage-survey/) | 2026-06-04 | Separate speed from value, treat early-2025 results as stale context (the METR RCT measured +19% completion time vs −20% perceived), and triangulate dogfood, reviewer reports, and runtime proof. |
